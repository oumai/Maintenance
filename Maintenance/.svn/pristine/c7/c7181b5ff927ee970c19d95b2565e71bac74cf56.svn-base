...
RE.delHeading = function(heading) {
...
RE.insertImage = function(url, alt) {
    var html = '<img src="' + url + '" alt="' + alt + '"  style="margin-left: -10px;width:calc(100% + 20px)"/></br>&nbsp';
    RE.insertHTML(html);
}
...
RE.enabledEditingItems = function(e) {
    ...
    //window.LocalObject.getAction(items.join(','));
