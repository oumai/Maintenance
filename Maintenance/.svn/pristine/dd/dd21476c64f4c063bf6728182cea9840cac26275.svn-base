...
//登录
#define Audist_STATION [[NSUserDefaults standardUserDefaults] boolForKey:@"AudistStation"]//登录状态
...
#define SET_Audist_STATION(bool) [[NSUserDefaults standardUserDefaults] setBool:bool forKey:@"AudistStation"];[[NSUserDefaults standardUserDefaults] synchronize];//改变登录状态
...
//蓝色UIColorFromRGB(40, 42, 116, 1)
#define BASE_COLOR UIColorFromHEX(0x2eb2ff, 1)
//#define BASE_COLOR UIColorFromHEX(0X282878, 1)
//背景灰色
//#define BASE_BACKGROUND_COLOR UIColorFromHEX(0xf5f5f5, 1)
//#define BASE_BACKGROUND_COLOR UIColorFromHEX(0xe0e0e0, 1)
#define BASE_BACKGROUND_COLOR UIColorFromRGB(243, 243, 243, 1)
//文字灰色
...
#define BASE_LINECOLOR UIColorFromRGB(243, 243, 243, 1)
//辅助色
