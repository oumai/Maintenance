...
/**
 ...
 - BATDoctorStudioConsultStatus_before: 未开始
 - BATDoctorStudioConsultStatus_ongoing: 未完成
 - BATDoctorStudioConsultStatus_end: 已完成
 */
typedef NS_ENUM(NSInteger,BATDoctorStudioConsultStatus){
    BATDoctorStudioConsultStatus_before = 0,
    BATDoctorStudioConsultStatus_ongoing = 1,
    BATDoctorStudioConsultStatus_end = 2,
};
