...
- (AFHTTPSessionManager *)requestManager
{
    ...
    if (_requestManager == nil) {
     ...
     //   _requestManager.requestSerializer.stringEncoding = NSUTF8StringEncoding;
        _requestManager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript", @"text/html",@"text/plain" ,@"image/png",@"image/jpeg",@"application/rtf",@"image/gif",@"application/zip",@"audio/x-wav",@"image/tiff",@"application/x-shockwave-flash",@"application/vnd.ms-powerpoint",@"video/mpeg",@"video/quicktime",@"application/x-javascript",@"application/x-gzip",@"application/x-gtar",@"application/msword",@"text/css",@"video/x-msvideo",@"text/xml",@"application/octet-stream", nil];
...
- (void)cancelRequest
{
    NSLog(@"%@",self.requestManager.operationQueue.operations);
